...
/**
 * @testcase test.com.jdedwards.system.connector.dynamic.sample.salesorder.TestSalesOrderEntryClient 
 */
public class SalesOrderEntryClient {
    ...
    SalesOrderEntryApplication orderApp = null;
    int sessionID = 0;

    boolean hasBeginDocCalled=false;

    public void SalesOrderEntryApplication() {
    }
    ...
    public void init(String[] args) throws Exception {
        ...
        //String imageFileName = (args.length == 0)?"SalesOrderEntry.xml":args[0];
        ...
        orderApp = new SalesOrderEntryApplication(sessionID, specSource);
    }
    ...
    private JFrame createOrderEntryFrame() {
        ...
        orderHeader = new OrderHeaderPane("SO");
...
//POEFrame.add(scrollPane, BorderLayout.SOUTH);
    ...
    private boolean executeBeginDoc() {
        ...
        if (szOrderType.length() == 0) {
            szOrderType = "SO";
            orderHeader.type.setText("SO");
        }
        inputParams.put("szOrderType", szOrderType);
        inputParams.put("szOrderCo",orderHeader.co.getText());
        ...
        inputParams.put("szBusinessUnit", szBusinessUnit);
        ...
        inputParams.put("mnAddressNumber", orderHeader.addressNo.getText());
        ...
        try {
            ...
            orderHeader.orderNo.setText(outputParams.get("mnOrderNo").toString());
            if (warning!=null) {
    ...
    private void executeEditLine() {
        ...
        inputParams.put("szItemNo", ((orderDetailModel.getValueAt(orderDetail.getSelectedRow(), 0)).toString()));
        inputParams.put("mnQtyOrdered", ((orderDetailModel.getValueAt(orderDetail.getSelectedRow(), 2)).toString()));
        inputParams.put("mnUnitPrice", ((orderDetailModel.getValueAt(orderDetail.getSelectedRow(), 3)).toString()));
        try {
            ...
            orderDetailModel.setValueAt(outputParams.get("mnQtyOrdered"), orderDetail.getSelectedRow(), 2);
    ...
    private void executeEndDoc() {
        ...
        Map inputParams = orderApp.createMappedRecord();
        Map outputParams = orderApp.createMappedRecord();
        inputParams.put("mnOrderTotal", orderHeader.orderTotal.getText());
        try {
...
//clean up panel
    ...
    private void doExit() {
        String msg1 = "Exit the Sales Order Entry?";
    ...
    public static void main(String[] args) throws Exception {
        SalesOrderEntryClient soe = new SalesOrderEntryClient();
        soe.init(args);
    }
